-- ============================================================
-- SIGA-COCIAP — 000: Estructura completa de la base de datos
-- Colegio de Aplicación "Víctor Valenzuela Guardia" — UNASAM
-- Huaraz, Ancash, Perú — 2026
-- Charset: utf8mb4 | Collation: utf8mb4_unicode_ci
--
-- Ejecutar PRIMERO, antes que cualquier seed o backup de datos.
-- Requiere usuario MySQL con privilegio CREATE DATABASE (root).
-- NO contiene registros — usar seeds o backup para los datos.
-- ============================================================
...
-- ════════════════════════════════════════════════════════════
-- 7. SUBÁREAS (solo para áreas de tipo 'con_subareas')
-- ════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════
-- 24. CALIFICACIONES POR CRITERIO
-- ════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════
-- 25. BLOQUEOS DE COMPETENCIA
-- Una vez bloqueada, el docente no puede modificar las notas
-- ════════════════════════════════════════════════════════════
