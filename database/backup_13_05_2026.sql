...
(16,'C18','Escribe diversos tipos de textos en su lengua materna.','Escribe diversos tipos de textos en su lengua materna',NULL,6,16),(17,'C19','Aprecia de manera crítica manifestaciones artístico-culturales.','Aprecia manifestaciones artísticas',NULL,3,17),
...
(21,'C23','Resuelve problemas de forma, movimiento y localización.','Resuelve problemas de forma, movimiento y localización',6,NULL,21),(22,'C24','Resuelve problemas de gestión de datos e incertidumbre.','Gestión de datos',7,NULL,22),
...
(30,'C30','Construye interpretaciones históricas.','Construye interpretaciones históricas',NULL,17,3),
(31,'C31','Gestiona responsablemente el espacio y el ambiente.','Gestiona responsablemente el espacio y el ambiente',NULL,17,4),
(32,'C32','Gestiona responsablemente los recursos económicos.','Gestiona responsablemente los recursos económicos',NULL,17,5),
...
(38,'C38','Se comunica oralmente en su lengua materna.','Se comunica oralmente',NULL,18,11),
(39,'C39','Lee diversos tipos de textos escritos en su lengua materna.','Lee diversos tipos de textos',NULL,18,12),
(40,'C40','Escribe diversos tipos de textos en su lengua materna.','Escribe diversos tipos de textos',NULL,18,13),
...
(44,'C44','Resuelve problemas de cantidad.','Resuelve problemas de cantidad',NULL,19,17),
(45,'C45','Resuelve problemas de regularidad, equivalencia y cambio.','Resuelve problemas de regularidad, equivalencia y cambio',NULL,19,18),
(46,'C46','Resuelve problemas de forma, movimiento y localización.','Resuelve problemas de forma, movimiento y localización',NULL,19,19),
(47,'C47','Resuelve problemas de gestión de datos e incertidumbre.','Resuelve problemas de gestión de datos e incertidumbre',NULL,19,20),
(48,'C48','Indaga mediante métodos científicos para construir sus conocimientos.','Indaga mediante métodos científicos',NULL,20,21),
(49,'C49','Explica el mundo físico basándose en conocimientos sobre los seres vivos; materia y energía; biodiversidad, Tierra y Universo.','Explica el mundo físico basándose en conocimientos sobre la Tierra y el Universo.',NULL,20,22),
(50,'C50','Diseña y construye soluciones tecnológicas para resolver problemas de su entorno.','Diseña y construye soluciones tecnológicas',NULL,20,23),
...
(54,'CT3','Se desenvuelve en entornos virtuales generados por las TIC.','Entornos virtuales / TIC',NULL,21,26),
(55,'CT4','Gestiona su aprendizaje de manera autónoma.','Aprendizaje autónomo',NULL,21,27);
